...
public class MainView implements ScreenView
{
    ...
    public void Initialize(Graphics graphics)
    {
        ...
        easyGame = new Button(Assets.btnLoadGame, glView.getScreenWidth()/2, glView.getScreenHeight()/2 - 2*(bluetoothGame.height + 10), false);
        easyGame.Scale(scale);
        easyGame.SetInvisible();
        easyGame.Lock();

        normalGame = new Button(Assets.btnLoadGame, glView.getScreenWidth()/2, glView.getScreenHeight()/2 - bluetoothGame.height - 10, false);
        normalGame.Scale(scale);
        normalGame.SetInvisible();
        normalGame.Lock();

        hardGame = new Button(Assets.btnLoadGame, glView.getScreenWidth()/2, glView.getScreenHeight()/2, false);
        hardGame.Scale(scale);
        hardGame.SetInvisible();
        hardGame.Lock();

        godGame = new Button(Assets.btnLoadGame, glView.getScreenWidth()/2, glView.getScreenHeight()/2 + bluetoothGame.height + 10, false);
        godGame.Scale(scale);

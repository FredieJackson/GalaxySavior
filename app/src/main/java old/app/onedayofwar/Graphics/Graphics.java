...
public class Graphics
{
    ...
    public void DrawText(String text, TextFont font, float x, float y, float rightBorder, int color, float size, boolean isCentered)
    {
        if(isCentered)
            font.DrawCenteredText(text, this, x, y, color, size);
        else

...
public class PlanetView implements ScreenView
{
    ...
    public void CheckButtons()
    {
        ...
        {
            selectedObject = 1;
            selectCredits.SetColorFilter(Color.argb(255, 0, 100, 255));
            selectOil.RemoveColorFilter();
            selectNanosteel.RemoveColorFilter();
        }
        ...
        {
            selectedObject = 2;
            selectOil.SetColorFilter(Color.argb(255, 0, 100, 255));
            selectCredits.RemoveColorFilter();
            selectNanosteel.RemoveColorFilter();
        }
        ...
        {
            selectedObject = 3;
            selectNanosteel.SetColorFilter(Color.argb(255, 0, 100, 255));
            selectOil.RemoveColorFilter();
            selectCredits.RemoveColorFilter();
        }
        else if(groundArmyBtn.IsClicked())

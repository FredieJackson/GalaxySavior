...
public class GLView extends GLSurfaceView
{
    ...
    public void LoadAssets(Graphics graphics)
    {
        ...
        Assets.btnEasyGame = graphics.LoadTexture("button/Legko.png");
        Assets.btnNormalGame = graphics.LoadTexture("button/Normalno.png");
        Assets.btnHardGame = graphics.LoadTexture("button/Trudno.png");
        Assets.btnGodGame = graphics.LoadTexture("button/Bog.png");

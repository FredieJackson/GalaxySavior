...
public class PlanetController
{
    ...
    public void LoadPlanets(Loader loader, XMLParser xmlParser)
    {
        ...
        for (int i = 0; i < planets.size(); i++)
        {
            ...
            while (true)
            {
                ...
                if (!planetPos.IsFalse())
                {
                    ...
                    planets.get(i).loadToMap(loader, "campaign/space/planets/" + (int)(Math.random()*11 + 1) +".png",  planetPos);
                    break;
                }
    ...
    public void LoadPlanets(Loader loader, DBController dbController)
    {
        dbController.LoadPlanets(loader, planets);
    }
    ...
    public void DrawPlanets(GLRenderer renderer)
    {

...
public class MoveBehavior
{
    ...
    {
        angle = (float)Math.acos(Round((float)((lastV.x*dir.x + lastV.y*dir.y)/(Math.sqrt(lastV.x*lastV.x + lastV.y*lastV.y)*Math.sqrt(dir.x*dir.x+dir.y*dir.y))), 3));
        angle *= 180f/Math.PI;
        needRotate = true;
        angleVector.SetValue(lastV.y, -lastV.x);
        rightAngle = (float)Math.acos(Round((float)((angleVector.x*dir.x + angleVector.y*dir.y)/(Math.sqrt(angleVector.x*angleVector.x + angleVector.y*angleVector.y)*Math.sqrt(dir.x*dir.x + dir.y*dir.y))), 3));
        angleVector.SetValue(-lastV.y, lastV.x);
        leftAngle = (float)Math.acos(Round((float)((angleVector.x*dir.x + angleVector.y*dir.y)/(Math.sqrt(angleVector.x*angleVector.x + angleVector.y*angleVector.y)*Math.sqrt(dir.x*dir.x + dir.y*dir.y))), 3));

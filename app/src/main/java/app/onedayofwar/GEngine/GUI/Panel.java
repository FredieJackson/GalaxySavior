...
public class Panel
{
    ...
    public void Draw(GLRenderer renderer)
    {
        //if(image == null)
        if(isClose || !isStop)
            renderer.DrawRectangle(matrix[12], matrix[13], 0, width, height, Color.BLACK, true);//g.drawRect(rect.left, rect.top, rect.width(), rect.height(), paint.getColor(), true);
        /*else
    ...
    public void DrawButton(GLRenderer renderer)
    {
        closeBtn.Draw(renderer);
    }

...
public class GameOverView implements ScreenView
{
    ...
    public void Draw(Graphics graphics)
    {
        ...
        graphics.DrawText("YOU " + (isVictory ? "WIN!" : "LOSE!"), Assets.gsFont, glView.getScreenWidth()/2, glView.getScreenHeight()/2, 0, Color.GREEN, 72, false);
        graphics.DrawText("Reward: " + reward, Assets.gsFont, glView.getScreenWidth()/2, glView.getScreenHeight()/2 + 80, 0, Color.GREEN, 72, false);
    }
